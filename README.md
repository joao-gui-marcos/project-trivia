...
## 👨‍💻 O que foi desenvolvido:
  ...
  - Foi desenvolvido um jogo de perguntas e respostas baseado no jogo Trivia, utilizando React e Redux, desenvolvendo suas funcionalidades de acordo com as demandas definidas em um quadro Kanban. A partir dessas demandas, temos uma aplicação onde a pessoa usuária pode:
